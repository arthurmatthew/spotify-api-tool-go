...
func GetProfile(username string, accessToken string, clientToken string) (*models.Profile, error) {
	url := fmt.Sprintf("https://spclient.wg.spotify.com/user-profile-view/v3/profile/%s?playlist_limit=10&artist_limit=10&episode_limit=10&market=US", username)
